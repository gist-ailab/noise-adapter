...
python train_rein_other_vfm.py -d ham10000 -g 0 -s dinov1b_adaptformer_0.0_sgd -n 0.0 --net dinov1 --adapter adaptformer
...
python train_rein_other_vfm.py -d ham10000 -g 0 -s maeb_adaptformer_0.0_sgd -n 0.0 --net mae --adapter adaptformer
...
python train_rein_other_vfm.py -d ham10000 -g 0 -s dinov2b_adaptformer_0.0_sgd -n 0.0 --net dinov2 --adapter adaptformer
