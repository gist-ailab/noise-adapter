...
python train_rein_other_vfm.py -d ham10000 -g 0 -s dinov1b_rein_0.4 -n 0.4 --net dinov1 --adapter adaptformer
...
python train_rein_other_vfm.py -d ham10000 -g 0 -s maeb_rein_0.4 -n 0.4 --net mae --adapter adaptformer
...
python train_rein_other_vfm.py -d ham10000 -g 0 -s dinov2b_rein_0.4 -n 0.4 --net dinov2 --adapter adaptformer
