for i in 0.0 0.2 0.4;
    do python train_resnet_ours_three_head_norein.py -d ham10000 -g 3 -s resnet50_3head_$i -n $i
done

for i in 0.0 0.2 0.4;
    do python train_resnet_ours_three_head_norein.py -d aptos -g 3 -s resnet50_3head_$i -n $i
done
